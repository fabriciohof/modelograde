...
grade = {'Segunda':['OC1','OC1','OC1','INTERVALO -','MAT','MAT','MAT','//'],'Terça':['MAT','MAT','//','INTERVALO -','RD1','RD1','RD1','RD1'],
'Quarta':['ICG','ICG','ICG','INTERVALO -','//','LEI','LEI','//'],'Quinta':['//','CEL','CEL','INTERVALO -','RD1','//','ICG','ICG'],
